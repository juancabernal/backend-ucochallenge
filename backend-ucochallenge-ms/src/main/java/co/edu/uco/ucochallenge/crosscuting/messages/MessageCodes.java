...
public final class MessageCodes {
        ...
        public static final class Domain {
                ...
                public static final class User {
                        ...
                        public static final String ID_NUMBER_INVALID_CHARS_TECHNICAL = "domain.user.idNumber.invalidChars.technical";
                        public static final String ID_NUMBER_INVALID_CHARS_USER = "domain.user.idNumber.invalidChars.user";
                        ...
                        public static final String EMAIL_FORMAT_INVALID_TECHNICAL = "domain.user.email.invalidFormat.technical";
                        ...
                        public static final String MOBILE_FORMAT_INVALID_TECHNICAL = "domain.user.mobile.invalidFormat.technical";
                        ...
                        public static final String EMAIL_ALREADY_REGISTERED_TECHNICAL = "domain.user.email.alreadyRegistered.technical";
                        public static final String EMAIL_ALREADY_REGISTERED_USER = "domain.user.email.alreadyRegistered.user";
                        public static final String ID_NUMBER_ALREADY_REGISTERED_TECHNICAL = "domain.user.idNumber.alreadyRegistered.technical";
                        public static final String ID_NUMBER_ALREADY_REGISTERED_USER = "domain.user.idNumber.alreadyRegistered.user";
                        public static final String MOBILE_ALREADY_REGISTERED_TECHNICAL = "domain.user.mobile.alreadyRegistered.technical";
                        public static final String MOBILE_ALREADY_REGISTERED_USER = "domain.user.mobile.alreadyRegistered.user";
        ...
        public static final class Infrastructure {
                ...
                public static final String MESSAGE_SERVICE_UNAVAILABLE = "infrastructure.messageService.unavailable.technical";
                public static final String MESSAGE_SERVICE_UNAVAILABLE_USER = "infrastructure.messageService.unavailable.user";
                public static final String PARAMETER_SERVICE_UNAVAILABLE = "infrastructure.parameterService.unavailable.technical";
                public static final String PARAMETER_SERVICE_UNAVAILABLE_USER = "infrastructure.parameterService.unavailable.user";
        }
}
