...
public class UpdateUserInteractorImpl implements UpdateUserInteractor {
        ...
        private final UpdateUserMapper mapper;

        public UpdateUserInteractorImpl(final UpdateUserUseCase useCase, final UpdateUserMapper mapper) {
        ...
        private List<LinkDTO> buildLinks(final UUID userId) {
                final String userPath = USERS_BASE_PATH + "/" + userId;
                return List.of(
                                LinkDTO.of("self", userPath, "GET"),
                                LinkDTO.of("update", userPath, "PUT"),
                                LinkDTO.of("delete", userPath, "DELETE"),
                                LinkDTO.of("collection", USERS_BASE_PATH, "GET"));
        }
}
